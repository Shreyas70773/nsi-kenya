          ...
          <ol className="flex flex-col">
            {ESTATES.map((e, i) => (
              <li
                ...
                data-reveal-item
                className={cn(
                  "hairline-t grid grid-cols-12 gap-4 py-6 md:gap-6 md:py-8",
                  i === ESTATES.length - 1 && "hairline-b",
                )}
              >
                <span className="font-mono-label col-span-2 text-[10px] text-faint md:col-span-1">
                  {String(i + 1).padStart(2, "0")}
                </span>
                <h3 className="font-display col-span-10 text-xl font-semibold tracking-tight md:col-span-4 md:text-2xl">
                  {e.name}
                </h3>
